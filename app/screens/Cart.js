...
>>>>>>> e4d286d5ea2f15e9a072a5357da260eb0b8b258b
            </ListItem>
          )}
          keyExtractor={(item, index) => index.toString()}
        />
        <Text style={{marginBottom: 60, paddingRight: 20, fontSize: 25, textAlign: "right"}}>Total = ${total}</Text>
        <Button full danger style={{position: 'absolute', left: 0, bottom:0, right: 0, height: 50}}
         onPress={() => this.props.navigation.navigate("Checkout")}><Text>Proceed to Checkout </Text></Button>
      </View>
    )
  }
}
